...
import { Heart, Music, Zap, ScrollText, Sparkles, Star } from 'lucide-react-native';
  ...
  return (
    ...
    >
      <View className="flex-row items-center">
        ...
        >
          <KindIcon size={20} color={colors.orange} />
        </View>

        <View className="flex-1">
          <Text
            className="text-[15px] font-pbold leading-5"
          ...
          <Text 
            className="text-[10px] font-pmedium uppercase tracking-tighter mt-0.5" 
